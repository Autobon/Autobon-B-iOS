...
- (void)_setView {
    ...
    UIView *womanView = [self messageButView:@"女" withSelected:YES withX:kWidth * 0.5 withY:(kHeight * 0.078 - kWidth * 0.051) * 0.5];
    ...
    CGFloat signInButY = CGRectGetMaxY(baseView2.frame) + kHeight * 0.065;
