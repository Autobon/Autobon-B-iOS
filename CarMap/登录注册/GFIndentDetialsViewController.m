...
- (void)_setView {
    ...
    self.bianhaoLab.text = @"订单fsadfhaskjhdgasjghdgsagasg";
    ...
    self.timeLab.text = @"预约时间：2016-01-28 15:00";
    ...
    lab4.text = @"备注: ";
    NSString *lab4Str = @"2015年5月1日2015";
