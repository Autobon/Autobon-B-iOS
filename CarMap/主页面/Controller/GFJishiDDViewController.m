//
//  GFJishiDDViewController.m
//  CarMapB
//
//  Created by 陈光法 on 16/12/15.
...
@interface GFJishiDDViewController () {
...
@implementation GFJishiDDViewController
...
- (void)_setPeoView {
    ...
    // 星级
    NSInteger sum = [_model.evaluate integerValue];
    CGFloat starW = 17;
    CGFloat starH = 17;
...
- (void)zhipaiButClick:(UIButton *)sender {
    ...
    [ACETelPrompt callPhoneNumber:_model.phone call:^(NSTimeInterval duration) {
